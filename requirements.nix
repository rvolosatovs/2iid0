...
#
# COMMAND:
#   pypi2nix -V 3.6 -e python-louvain
#
...
let
  ...
  generated = self: {
    ...
    "python-louvain" = python.mkDerivation {
      name = "python-louvain-0.9";
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/a6/77/77b779f336e6a689c97ee3a5181501c94496166ca736c1783b01b7a68ee3/python-louvain-0.9.tar.gz"; sha256 = "82fad0243f4e923801fcfc4b83ca4f742f5bdb4f99abbdc673c7c34ea6fd2885"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."networkx"
